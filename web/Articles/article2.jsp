<%-- 
    Document   : article2
    Created on : 16-Dec-2023, 6:45:00 pm
    Author     : 91939
--%>
...
<body>
    <h5><b>
        Roads across Kolkata lie battered</b></h5>
        Mayor sets Mahalaya deadline for repairs: Official
        Patholes have sprung up on the Ruby-bound flank of EM Bypass near the Avishikta crossing and also on the stretch of the Bypass near the transport department’s office, to the north of the Ruby crossing.
<img src="https://assets.telegraphindia.com/telegraph/2023/Sep/1694993880_new-project.jpg"height="100%"width="100%">
